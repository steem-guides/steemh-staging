...
\hypertarget{snax}{%
\section[Snax ]{\texorpdfstring{Snax \footnote{作者:@jianan;编辑:@jianan;原文链接:\url{https://steemit.com/cn/@jianan/snax}}}{Snax }}\label{snax}}

\includegraphics{images/chapter_09_0/snax.png}

\hypertarget{snax}{%
\subsection{给社交平台用户的一盒糖果（Snax）}\label{snax}}
...
\includegraphics{images/chapter_09_0/snax2.png}

\hypertarget{snax}{%
\subsection{有关Snax的体验和奖励指标。}\label{snax}}
