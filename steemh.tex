...
\hypertarget{50-spcnbuddy}{%
\subsection{在这里，我们举一个例子来算算看代理50 SP给@cnbuddy能收到多大的赞：}\label{50-spcnbuddy}}
...
解释了代理SP的用处及好处，接下来，要分享关于：

\hypertarget{sp}{%
\subsection{如何操作才能代理SP给别人}\label{sp}}
...
其实，还有其他方法可以代理（delegate）SP，有兴趣者，可参考@minloulou的文章：\href{https://busy.org/@minloulou/sp3sp2-ogzvhsoiey}{https://busy.org/\citet{minloulou/sp3sp2-ogzvhsoiey}}。
